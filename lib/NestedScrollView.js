...
/**
 * Forked from https://github.com/facebook/react-native/blob/master/Libraries/Components/ScrollView/ScrollView.js
 * Replaced RCTScrollView to RCTNestedScrollView
 *
 ...
 * a scroll interaction). In order to bound the height of a NestedScrollView, either
 ...
 */
const NestedScrollView = React.createClass({
  propTypes: {
    ...View.propTypes,
    /**
     ...
     * functionality for the NestedScrollView.
     *
   ...
   * operations like `scrollTo`. All NestedScrollView-like components should
   * implement this method so that they can be composed while providing access
   * to the underlying scroll responder's methods.
   */
  getScrollResponder: function(): NestedScrollView {
    return this;
  },
    ...
    if (__DEV__) {
      if (this.props.onScroll && this.props.scrollEventThrottle == null && Platform.OS === 'ios') {
        console.log( // eslint-disable-line no-console-disallow
          'You specified `onScroll` on a <NestedScrollView> but not ' +
  ...
  _scrollViewRef: (null: ?NestedScrollView),
  _setScrollViewRef: function(ref: ?NestedScrollView) {
...
if (Platform.OS === 'android') {
  ...
  AndroidScrollView = requireNativeComponent('RCTNestedScrollView', NestedScrollView, nativeOnlyProps);
  ...
  RCTScrollView = requireNativeComponent('RCTNestedScrollView', NestedScrollView, nativeOnlyProps);
}
